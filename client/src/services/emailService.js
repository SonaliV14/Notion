...
//     const mailOptions = {
//       from: `"${process.env.APP_NAME || 'NotionClone'}" <${process.env.EMAIL_USER}>`,
//       to: recipientEmail,
//       subject: `${inviterName} invited you to collaborate on "${pageTitle}"`,
//       html: `
//         <!DOCTYPE html>
//         <html>
//         <head>
...
//               <p><strong>${inviterName}</strong> has invited you to collaborate on a page:</p>
...
//                 ${role === 'editor' || role === 'admin' ? '<li>Edit and update the page</li><li>Add and modify blocks</li>' : ''}
//                 ${role === 'admin' ? '<li>Manage collaborators</li><li>Delete the page</li>' : ''}
//               </ul>
...
//             </div>
//             <div class="footer">
//               <p>© ${new Date().getFullYear()} ${process.env.APP_NAME || 'NotionClone'}. All rights reserved.</p>
//             </div>
//           </div>
//         </body>
//         </html>
